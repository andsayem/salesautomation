...
public class FOForecastWebRemark extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linlay_exit_from_web.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FOForecastWebRemark.this.finish();
            }
        });
        ...
        String url = getResources().getString(R.string.base_url)+"api/fo-sales-forecasting/"+SharePreference.getUserId(context)+"/pg-remarks/create";
