...
public class OnlineExamWeb extends AppCompatActivity {
...
//        });
     ...
     //   alertBulder.show();
      ...
      //  String url = getResources().getString(R.string.base_url)+"tabs/login/"+getIntent().getStringExtra("poient_id")+"/"+getIntent().getStringExtra("routeId")+"/"+getIntent().getStringExtra("retailerId")+"/part_1/"+ SharePreference.getUserLoginId(context)+"/"+SharePreference.getUserLoginPassword(context);
      //  String url ="https://onlineexamdev.ssgbd.com/ssforce-login?user_id="+SharePreference.getUserId(context);
