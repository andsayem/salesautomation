...
public class ProductTrackingWeb extends AppCompatActivity {

    private WebView webView;
    Context context;
    String TAG = "ProductTracking";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = getResources().getString(R.string.base_url)+"visitor_verify_app";
