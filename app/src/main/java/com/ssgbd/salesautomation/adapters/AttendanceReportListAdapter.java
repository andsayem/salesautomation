 ...
 */
public class AttendanceReportListAdapter extends RecyclerView.Adapter<AttendanceReportListAdapter.NewReleasesItemViewHolder> {
    ...
    AttendanceReportFragment todaysOrderFragment;


    public AttendanceReportListAdapter(ArrayList<AttendanceReportListDTO> items, Context context, AttendanceReportFragment tof) {
    ...
    public NewReleasesItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.from(context).inflate(R.layout.row_attendance_report_list, parent, false);
