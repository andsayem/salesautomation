 ...
 */
public class ConfirmOrderRecyclerAdapter extends RecyclerView.Adapter<ConfirmOrderRecyclerAdapter.NewReleasesItemViewHolder>{

    public ArrayList<ConfirmOrderDTO> orderList;
    public ArrayList<ConfirmOrderDTO> arrayList;
    private Context context;
    private LayoutInflater inflater;
    private Animation animation;


    public ConfirmOrderRecyclerAdapter(ArrayList<ConfirmOrderDTO> items, Context context) {
        this.orderList = items;
        this.context = context;

        this.arrayList = new ArrayList<ConfirmOrderDTO>();
    ...
    public NewReleasesItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
               View view = inflater.from(context).inflate(R.layout.row_confirm_order_product,parent,false);
    ...
    public void onBindViewHolder(final NewReleasesItemViewHolder holder, final int position) {
        ...
        final ConfirmOrderDTO itemFeed = orderList.get(position);
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (ConfirmOrderDTO hm : arrayList) {
