 ...
 */
public class FOLeaveListRecyclerAdapter extends RecyclerView.Adapter<FOLeaveListRecyclerAdapter.NewReleasesItemViewHolder>{

    public ArrayList<FOLeaveListDTO> utilityLists;
    private Context context;
    private LayoutInflater inflater;
    private Animation animation;
    FoLeaveFragment foLeaveFragment;
    String today;

    public FOLeaveListRecyclerAdapter(ArrayList<FOLeaveListDTO> items, Context context,FoLeaveFragment fl,String today) {
    ...
    public NewReleasesItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.from(context).inflate(R.layout.row_fo_leave_list,parent,false);
