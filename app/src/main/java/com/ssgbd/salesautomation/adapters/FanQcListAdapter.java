 ...
 */
public class FanQcListAdapter extends RecyclerView.Adapter<FanQcListAdapter.NewReleasesItemViewHolder> {
    ...
    FanQCListFragment fanQCListFragment;


    public FanQcListAdapter(ArrayList<VisitReportDTO> items, Context context, FanQCListFragment tof) {
        this.orderList = items;
        this.context = context;
        this.fanQCListFragment = tof;
