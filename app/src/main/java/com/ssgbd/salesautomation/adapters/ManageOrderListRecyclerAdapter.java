 ...
 */
public class ManageOrderListRecyclerAdapter extends RecyclerView.Adapter<ManageOrderListRecyclerAdapter.NewReleasesItemViewHolder>{
    ...
    public ManageOrderListRecyclerAdapter(ArrayList<ManageOrderDTO> items, Context context ) {
