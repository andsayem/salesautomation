 ...
 */
public class OrderVsDeliveryReportListAdapter extends RecyclerView.Adapter<OrderVsDeliveryReportListAdapter.NewReleasesItemViewHolder> {
    ...
    DeliveryVsOrderReportFragment todaysOrderFragment;


    public OrderVsDeliveryReportListAdapter(ArrayList<OrderRepotListDTO> items, Context context, DeliveryVsOrderReportFragment tof) {
       ...
       //    String.valueOf(Math.round(Float.valueOf(twoDForm.format(itemFeed.getDeliveryValue()))));
            ...
            holder.row_order_no.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String url="order-vs-delivery-details?order_id="+itemFeed.getOrderId()+"&username="+ SharePreference.getUserLoginId(context)+"&password="+SharePreference.getUserLoginPassword(context);
