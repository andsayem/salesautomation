 ...
 */
public class PGFreeReportListAdapter extends RecyclerView.Adapter<PGFreeReportListAdapter.NewReleasesItemViewHolder> {
    ...
    PGFreeReportFragment todaysOrderFragment;


    public PGFreeReportListAdapter(ArrayList<ReturnChangeReportListDTO> items, Context context, PGFreeReportFragment tof) {
