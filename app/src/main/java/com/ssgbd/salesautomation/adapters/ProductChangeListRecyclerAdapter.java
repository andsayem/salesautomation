 ...
 */
public class ProductChangeListRecyclerAdapter extends RecyclerView.Adapter<ProductChangeListRecyclerAdapter.NewReleasesItemViewHolder>{
    ...
    public ProductChangeListRecyclerAdapter(ArrayList<ProductDTO> items, Context context) {
