 ...
 */
public class ProductStrengthOthersCategoryRecyclerAdapter extends RecyclerView.Adapter<ProductStrengthOthersCategoryRecyclerAdapter.NewReleasesItemViewHolder>{
    ...
    public ProductStrengthOthersCategoryRecyclerAdapter(ArrayList<ProductStrengthDTO> items, Context context) {
    ...
    public NewReleasesItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
               View view = inflater.from(context).inflate(R.layout.row_others_product_category_strenth,parent,false);
    ...
    public void onBindViewHolder(final NewReleasesItemViewHolder holder, final int position) {
        ...
        try {
           ...
           // holder.category_name.setText(itemFeed.getCompanyName());
    ...
    public class NewReleasesItemViewHolder extends RecyclerView.ViewHolder{
      ...
      //  CircleImageView user_circleImageView;
        ...
        public NewReleasesItemViewHolder(View itemView) {
           ...
           // user_circleImageView = (CircleImageView) itemView.findViewById(R.id.user_circleImageView);
        }
    }
