 ...
 */
public class RetailerRecyclerAdapterCollection extends RecyclerView.Adapter<RetailerRecyclerAdapterCollection.NewReleasesItemViewHolder>{
    ...
    public RetailerRecyclerAdapterCollection(ArrayList<RetailerDTO> items, Context context) {
