 ...
 */
public class RetailerRecyclerAdapter_Return_Change extends RecyclerView.Adapter<RetailerRecyclerAdapter_Return_Change.NewReleasesItemViewHolder>{
    ...
    ReturnAndChangeFragment visitFragment;

    public RetailerRecyclerAdapter_Return_Change(ArrayList<RetailerDTO> items, Context context, ReturnAndChangeFragment visitFragment) {
    ...
    public NewReleasesItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.from(context).inflate(R.layout.row_retailer_return_change,parent,false);
    ...
    public void onBindViewHolder(final NewReleasesItemViewHolder holder, final int position) {
        ...
        try {
            ...
            holder.row_status.setText(itemFeed.getStatus());
            holder.row_return_and_change.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    Intent intent = new Intent(context, ReturnAndChangeActivity.class);
    ...
    public class NewReleasesItemViewHolder extends RecyclerView.ViewHolder{
        public TextView row_retailer_name,row_return_and_change,row_status;
