 ...
 */
public class ReturnChangeDeliveryReportListAdapter extends RecyclerView.Adapter<ReturnChangeDeliveryReportListAdapter.NewReleasesItemViewHolder> {
    ...
    public ReturnChangeDeliveryReportListAdapter(ArrayList<ReturnChangeReportListDTO> items, Context context) {
    ...
    public void onBindViewHolder(final NewReleasesItemViewHolder holder, final int position) {
        ...
        try {
            ...
            float i = Float.parseFloat(itemFeed.getChangevalue());
            float ii = Float.parseFloat(itemFeed.getValue());
            float f=i-ii;
            ...
            holder.row_return_order.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String url="apps-return-change-products-details?order_id="+itemFeed.getReturnOrderId()+"&username="+ SharePreference.getUserLoginId(context)+"&password="+SharePreference.getUserLoginPassword(context);
    ...
    public class NewReleasesItemViewHolder extends RecyclerView.ViewHolder {
        public TextView row_sl,row_return_order,row_return_order_date,row_fo,row_customer,row_return_qty,row_return_value,row_change_qty,row_change_value,row_excess_amount;
