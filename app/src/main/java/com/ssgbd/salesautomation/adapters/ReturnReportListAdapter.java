 ...
 */
public class ReturnReportListAdapter extends RecyclerView.Adapter<ReturnReportListAdapter.NewReleasesItemViewHolder> {
    ...
    ReturnReportFragment todaysOrderFragment;


    public ReturnReportListAdapter(ArrayList<OrderRepotListDTO> items, Context context, ReturnReportFragment tof) {
        ...
        try {
            ...
            holder.row_order_no.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                  ...
                  //  String url="report/return-order-details"+ SharePreference.getUserLoginId(context)+"/"+SharePreference.getUserLoginPassword(context)+"/"+itemFeed.getOrderId()+"/"+SharePreference.getUserId(context);
                    String url="report/app-return-order-details/"+ SharePreference.getUserLoginId(context)+"/"+SharePreference.getUserLoginPassword(context)+"/"+itemFeed.getOrderId()+"/"+SharePreference.getUserId(context);
