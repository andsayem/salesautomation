 ...
 */
public class TodaysOrderListRecyclerAdapter extends RecyclerView.Adapter<TodaysOrderListRecyclerAdapter.NewReleasesItemViewHolder> {
    ...
    TodaysOrderFragment todaysOrderFragment;


    public TodaysOrderListRecyclerAdapter(ArrayList<DBOrderDTO> items, Context context, TodaysOrderFragment tof) {
        ...
        try {
            ...
            holder.row_txt_confirm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!isInternetAvailable(context)) {
                        ...
                        holder.row_txt_confirm.setVisibility(View.GONE);
            ...
            holder.row_txt_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("retailerId", itemFeed.getRetailerId());
                    intent.putExtra("poient_id", itemFeed.getPoientId());
                    intent.putExtra("retailerName", itemFeed.getRetailerName());
