 ...
 */
public class WastageDeliveryReportListAdapter extends RecyclerView.Adapter<WastageDeliveryReportListAdapter.NewReleasesItemViewHolder> {
    ...
    public WastageDeliveryReportListAdapter(ArrayList<OrderRepotListDTO> items, Context context) {
    ...
    public NewReleasesItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.from(context).inflate(R.layout.row_delivery_report_list, parent, false);
    ...
    public void onBindViewHolder(final NewReleasesItemViewHolder holder, final int position) {
        ...
        try {
            ...
            holder.row_wastage_replaceqty.setText(itemFeed.getReplaceQty());
            holder.row_wastage_replacevalue.setText(itemFeed.getReplaceValue());
            float i = Float.parseFloat(itemFeed.getOrderValue());
            float ii = Float.parseFloat(itemFeed.getReplaceValue());
            float f=ii-i;
                    holder.row_wastage_excessamount.setText(String.valueOf(f));

            holder.row_order_no.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(context, ReportWeb.class);
                    String url="apps-wastage-delivery-details?order_id="+itemFeed.getOrderId()+"&username="+SharePreference.getUserLoginId(context)+"&password="+SharePreference.getUserLoginPassword(context);
    ...
    public class NewReleasesItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView row_wastage_replaceqty,row_wastage_replacevalue,row_wastage_excessamount;
        ...
        public NewReleasesItemViewHolder(View itemView) {
            ...
            row_wastage_replaceqty = (TextView) itemView.findViewById(R.id.row_wastage_replaceqty);
            row_wastage_replacevalue = (TextView) itemView.findViewById(R.id.row_wastage_replacevalue);
            row_wastage_excessamount = (TextView) itemView.findViewById(R.id.row_wastage_excessamount);
