...
import com.ssgbd.salesautomation.MainActivity;
...
public class OrderManageFragment extends Fragment {
    ...
    ManageOrderListRecyclerAdapter manage_order_adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.order_manage_fragment, container, false);
    ...
    private void initUi(View rootView) {
        ...
        manage_order_adapter = new ManageOrderListRecyclerAdapter( orderListDTOS,getActivity());
    ...
    private void getOrderList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, getResources().getString(R.string.base_url)+"api/apps/order-manage-list",
