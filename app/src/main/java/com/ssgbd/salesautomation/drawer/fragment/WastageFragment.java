...
public class WastageFragment extends Fragment implements View.OnClickListener{
    ...
    RetailerRecyclerAdapter_Westage retialer_adapter;
   ...
   // private static String DB_PATH = "/data/data/com.ssgbd.salesautomation/databases/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.wastage_fragment, container, false);
        ...
        retialer_adapter = new RetailerRecyclerAdapter_Westage( retailerDTOS,getActivity(),this);
...
//        }
    ...
    public void onResume() {
      ...
      //  Log.e("onResume","onResume"+"onResume");
        ...
        statusDTOS = databaseHelper.getAllWastageStatus(databaseHelper,SharePreference.getUserId(getActivity()),formattedDate);
...
//              //retialer_adapter.notifyDataSetChanged();
                ...
                retailer_list_recyclerView.setLayoutManager(linearLayoutManager1);
                retialer_adapter = new RetailerRecyclerAdapter_Westage( retailerDTOS,getActivity(), WastageFragment.this);
                retailer_list_recyclerView.setAdapter(retialer_adapter);
