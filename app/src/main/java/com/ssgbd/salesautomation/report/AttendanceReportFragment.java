...
public class AttendanceReportFragment extends Fragment implements View.OnClickListener{
    ...
    AttendanceReportListAdapter retialer_adapter;
   ...
   // private static String DB_PATH = "/data/data/com.ssgbd.salesautomation/databases/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.attendance_report_fragment, container, false);
        ...
        retialer_adapter = new AttendanceReportListAdapter( changeReportListDTOS,getActivity(), AttendanceReportFragment.this);
        retailer_list_recyclerView.setAdapter(retialer_adapter);


        String d=Utility.current_year+"-"+(Utility.current_month+1)+"-"+Utility.to_day;
...
//                              txt_month_year.setText(dayOfMonth + "/" + (monthOfYear + 1) + "/" + year);
                        ...
                        }, Utility.current_year, Utility.current_month, Utility.to_day);
                picker.show();
            }
        });
    ...
    public void attendanceReportHRIS(String fdate,String tdate){
        changeReportListDTOS.clear();
        retialer_adapter.notifyDataSetChanged();
        final ProgressDialog pd = new ProgressDialog(getActivity());
        pd.setMessage("Loading...");
      ...
      //  Log.e("<<>>","api/Attendance?fromDate="+fdate+"&toDate="+tdate+"&employeeCode="+SharePreference.getEmployeeId(getActivity())+"&fNmIndHr="+SharePreference.getAndroidId(getActivity())+"");
        StringRequest stringRequest = new StringRequest(Request.Method.GET, getString(R.string.base_url_hris)+"api/Attendance?fromDate="+fdate+"&toDate="+tdate+"&employeeCode="+SharePreference.getEmployeeId(getActivity())+"&fNmIndHr="+SharePreference.getAndroidId(getActivity()) , new Response.Listener<String>() {
            @Override
                    ...
                    public void run() {
                        ...
                        //    Log.e("Alist",response+"response");
                                ...
                                for (int i=0;i<jsonArray.length();i++){
                                    ...
                                    //in
                                    listDTO.setDate(optStringNullCheck(object,"date"));
                                    listDTO.setInTime(optStringNullCheck(object,"timeIn"));
//                                    listDTO.setInTimeRetailerName(optStringNullCheck(object,"inTimeRetailerName"));
//                                    listDTO.setInTimeRetailerAddress(optStringNullCheck(object,"inTimeRetailerAddress"));
//                                    //out
                                    listDTO.setOutTime(optStringNullCheck(object,"timeOut"));
//                                    listDTO.setOutTimeRetailerName(optStringNullCheck(object,"outTimeRetailerName"));
//                                    listDTO.setOutTimeRetailerAddress(optStringNullCheck(object,"outTimeRetailerAddress"));
                                    listDTO.setWorkingHoure(optStringNullCheck(object,"workingHour"));

                                    listDTO.setRoute(optStringNullCheck(object,"rosterTime"));
//                                    listDTO.setLeave(optStringNullCheck(object,"leave"));
//                                    listDTO.setLeaveName(optStringNullCheck(object,"leaveName"));
//                                    listDTO.setAbsent(optStringNullCheck(object,"absent"));
                                    listDTO.setFriday(optStringNullCheck(object,"status"));
