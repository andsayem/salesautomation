...
public class DeliveryVsOrderReportFragment extends Fragment implements View.OnClickListener{

    View rootView;
    VolleyMethods vm = new VolleyMethods();
    OrderVsDeliveryReportListAdapter retialer_adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        retialer_adapter = new OrderVsDeliveryReportListAdapter( changeReportListDTOS,getActivity(), DeliveryVsOrderReportFragment.this);
...
//                              txt_month_year.setText(dayOfMonth + "/" + (monthOfYear + 1) + "/" + year);
    ...
    public void getReport(String fromDAte,String TODate){
        ...
        vm.sendRequestToServer2(getActivity(),  getString(R.string.base_url)+"api/report/order-delivery",
