...
public class OrderReportFragment extends Fragment implements View.OnClickListener{
    ...
    OrderReportListAdapter orderReportListAdapter;
   ...
   // private static String DB_PATH = "/data/data/com.ssgbd.salesautomation/databases/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.order_report_fragment, container, false);
        ...
        orderReportListAdapter = new OrderReportListAdapter( orderRepotListDTOS,getActivity(), OrderReportFragment.this);
