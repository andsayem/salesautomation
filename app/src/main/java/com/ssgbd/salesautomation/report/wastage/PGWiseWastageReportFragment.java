...
public class PGWiseWastageReportFragment extends Fragment implements View.OnClickListener{
   ...
   // private static String DB_PATH = "/data/data/com.ssgbd.salesautomation/databases/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.pg_wise_wastage_fragment, container, false);
        ...
        txt_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (FROMDATE.equalsIgnoreCase("")){
                    ...
                    String url = getString(R.string.base_url) + "apps-pg-wise-wastage-list?fromdate="+FROMDATE+"&todate="+TODATE + "&category_id="+CATEGORY_ID+"&username="+SharePreference.getUserLoginId(getActivity()) + "&password=" + SharePreference.getUserLoginPassword(getActivity());
                    webView.loadUrl(url);
