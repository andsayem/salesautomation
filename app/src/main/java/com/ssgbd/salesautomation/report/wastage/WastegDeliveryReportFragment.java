...
import com.ssgbd.salesautomation.adapters.WastageDeliveryReportListAdapter;
...
public class WastegDeliveryReportFragment extends Fragment implements View.OnClickListener{

    View rootView;
    VolleyMethods vm = new VolleyMethods();
    WastageDeliveryReportListAdapter orderReportListAdapter;
...
//    private static String DB_PATH = "/data/data/com.ssgbd.salesautomation/databases/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.wasteg_delivery_report_fragment, container, false);
        ...
        orderReportListAdapter = new WastageDeliveryReportListAdapter( orderRepotListDTOS,getActivity());
    ...
    public  void getWastageOrder(){
        ...
        StringRequest sr = new StringRequest(Request.Method.POST,getString(R.string.base_url)+"api/apps-wastage-delivery-list", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {

             //   Log.e("<<atres>>",response.toString()+"");
                ...
                try {
                    ...
                    for (int i=0;i<jsonArray.length();i++){
                        ...
                        listDTO.setReplaceQty(optStringNullCheck(object,"total_delivery_qty"));
                        listDTO.setReplaceValue(optStringNullCheck(object,"total_delivery_value"));
