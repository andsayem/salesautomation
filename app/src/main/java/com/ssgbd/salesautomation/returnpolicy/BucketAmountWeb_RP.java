...
public class BucketAmountWeb_RP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = getResources().getString(R.string.base_url)+"tabs/return-login/"+getIntent().getStringExtra("poient_id")+"/"+getIntent().getStringExtra("routeId")+"/"+getIntent().getStringExtra("retailerId")+"/part_1/"+ SharePreference.getUserLoginId(context)+"/"+SharePreference.getUserLoginPassword(context);
