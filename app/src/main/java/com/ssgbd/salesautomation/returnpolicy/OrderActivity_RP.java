...
public class OrderActivity_RP extends AppCompatActivity implements View.OnClickListener{
                        ...
                        alertBulder.setPositiveButton(getString(R.string.yes), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                               ...
                               // linlay_buket_amount.setClickable(true);
                                isSaved = "1";
                                linlay_category_portion.setVisibility(View.GONE);
...
//    }
    ...
    public void confirmOrder(){
       ...
       // Log.e("send>>",finalobject.toString()+"");
        vm.sendRequestToServer(context, getResources().getString(R.string.base_url)+"api/apps/return-order-confirm", finalobject.toString(), new VolleyCallBack() {
            @Override
            public void onSuccess(String result) {
                try {
                    JSONObject jsonObject = new JSONObject(result);
                 ...
                 //   Log.e("<<>>>>",jsonObject.toString()+"<<>>");
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("1")){
                        ...
                        Intent intent = new Intent(OrderActivity_RP.this,BucketAmountWeb_RP.class);
