...
public class ManageReturnActivityWeb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = getResources().getString(R.string.base_url)+"tabs/return-loginom/"+getIntent().getStringExtra("orderid")+"/"+getIntent().getStringExtra("retailerId")+"/"+getIntent().getStringExtra("routeId")+"/part_1/"+ SharePreference.getUserLoginId(context)+"/"+SharePreference.getUserLoginPassword(context);
        ...
        linlay_exit_from_web.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ManageReturnActivityWeb.this.finish();
            }
        });
