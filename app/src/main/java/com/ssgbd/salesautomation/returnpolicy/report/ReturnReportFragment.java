...
import com.ssgbd.salesautomation.adapters.ReturnReportListAdapter;
...
public class ReturnReportFragment extends Fragment implements View.OnClickListener{
    ...
    ReturnReportListAdapter orderReportListAdapter;
   ...
   // private static String DB_PATH = "/data/data/com.ssgbd.salesautomation/databases/";
    ...
    TextView txt_total_count,txt_fromdate,txt_todate,txt_route,txt_search;
    TextView total_qty,total_value;
    String formattedDate="";
    DatePickerDialog picker;
    String FROMDATE="",TODATE="";

    float totalqty,totalvalue;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.return_report_fragment, container, false);
        ...
        orderReportListAdapter = new ReturnReportListAdapter( orderRepotListDTOS,getActivity(), ReturnReportFragment.this);
...
//                              txt_month_year.setText(dayOfMonth + "/" + (monthOfYear + 1) + "/" + year);
    ...
    public void getReport(){
        ...
        vm.sendRequestToServer2(getActivity(),  getString(R.string.base_url)+"api/report/return-order-list",
                            ...
                            public void run() {
                                ...
                                //    Log.e("jsonObject1",jsonObject1+"");
                                    ...
                                    for (int i=0;i<jsonArray.length();i++){
                                        ...
                                        listDTO.setCustomerName(optStringNullCheck(object,"name")+"("+optStringNullCheck(object,"retailer_id")+")"+"\n"+optStringNullCheck(object,"mobile"));
                                        ...
                                        totalqty += Float.parseFloat(optStringNullCheck(object,"total_qty"));
                                        totalvalue += Float.parseFloat(optStringNullCheck(object,"total_value"));

                                    }

                                    total_qty.setText(String.valueOf(Math.round(totalqty)));
                                    total_value.setText(String.valueOf(totalvalue));


                                    txt_total_count.setText(" About-"+String.valueOf(orderRepotListDTOS.size())+" results");
